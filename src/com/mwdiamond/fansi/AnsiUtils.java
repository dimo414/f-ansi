...
class AnsiUtils {
    ...
    public void ok(String message, Object ... args) {
        ansi().out("[ ").color(GREEN).out("OK").out("   ] ").outln(message, args);
    }

    public void warn(String message, Object ... args) {
        ansi().out("[ ").color(YELLOW).out("WARN").out(" ] ").outln(message, args);
    }

    public void fail(String message, Object ... args) {
        ansi().out("[ ").color(RED).out("FAIL").out(" ] ").outln(message, args);
    }
