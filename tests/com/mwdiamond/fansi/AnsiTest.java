...
public class AnsiTest {
    ...
    public void colorBackground() {
        ansi().color(GREEN, RED).out(HELLO);
    ...
    public void colorStyle() {
        ansi().color(YELLOW, BOLD).out(HELLO);
    ...
    public void colorStyles() {
        ansi().color(CYAN, BOLD, ITALIC).out(HELLO);
    ...
    public void colorFont() {
        ansi().color(BLUE, F1).out(HELLO);
        assertThat(ansiForTests.getStdout()).isEqualTo("\\e[11;34m" + HELLO + "\\e[10m\\e[m");
    }

    @Test
    public void chainedColor() {
        ansi().color(BLUE).out(HELLO).color(RED, GREEN).out(HELLO);
        assertThat(ansiForTests.getStdout()).isEqualTo("\\e[34m" + HELLO + "\\e[m\\e[31;42m" + HELLO + "\\e[m");
    }
    ...
    public void color24Bit() {
        ...
        assertThat(ansiForTests.getStdout()).isEqualTo("\\e[38;2;255;0;0;48;2;0;0;255m" + HELLO + "\\e[m");
    }
    ...
    public void fixedColor() {
        ansi().fixed(10, 20).color(RED).outln(HELLO);
        ansi().color(RED).fixed(10, 20).outln(HELLO);
